export default function FeaturesSection() {
  return (
    <>
      <div className="w-[80%] mx-auto max-md:p-[1rem] mt-[4rem]">
        <div className="text-center">
          <h2 className="text-[#1e1e1e] text-[4rem] tracking-tighter max-md:text-[2rem]">
        ...
        <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-12 mt-16">
          <div className="text-center bg-[#fff] p-[1rem] rounded-[15px] shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="white"
              className="w-12 mb-6 inline-block bg-[#1e1e1e] p-3 rounded-xl"
              viewBox="0 0 32 32"
            >
              <path
            ...
            <a
              ...
              className="text-blue-600 font-bold inline-block text-sm mt-3 hover:underline"
            >
              Learn more
            </a>
          </div>
          ...
          <div className="text-center bg-[#fff] p-[1rem] rounded-[15px] shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            ...
            <p className="text-gray-600 text-sm">
              Easily scale your resources to meet growing demands.
            </p>
            <a
              href="javascript:void(0);"
              className="text-blue-600 font-bold inline-block text-sm mt-3 hover:underline"
