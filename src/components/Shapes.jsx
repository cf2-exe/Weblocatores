  ...
  >
    ...
    <defs>
      ...
      >
        ...
        <stop offset="1" stopColor="#FFE927" stopOpacity="0" />
      </radialGradient>
  ...
  >
    <g clipPath="url(#cs_clip_1_flower-2)">
      ...
      <g mask="url(#cs_mask_1_flower-2)">
        <path d="M200 0H0v200h200V0z" fill="#fff" />
        <path d="M200 0H0v200h200V0z" fill="url(#paint0_linear_748_4701)" />
    ...
    <g style={{ mixBlendMode: "overlay" }} mask="url(#cs_mask_1_flower-2)">
      <path
        d="M200 0H0v200h200V0z"
        fill="gray"
        stroke="transparent"
        filter="url(#cs_noise_1_flower-2)"
      />
    </g>
    <defs>
      <filter
